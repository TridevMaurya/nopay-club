...
var InternshipSection = function () {
    return (<motion.section className="py-12 px-4 md:px-12 relative z-10" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.7 }}>
      <div className="container mx-auto">
        <div className="glass-panel rounded-2xl p-6 md:p-10 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <motion.h2 className="font-space font-bold text-3xl md:text-5xl mb-6 text-center neon-text-green" initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.8 }}>
              Internship Opportunity
            </motion.h2>
            <motion.p className="text-center text-text-light opacity-80 max-w-2xl mx-auto mb-12" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.9 }}>
