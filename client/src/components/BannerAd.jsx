...
var BannerAd = function (_a) {
    ...
    return (<div className={"container mx-auto ".concat(getStyle())}>
      <motion.div className="w-full h-24 md:h-32 glass-panel rounded-xl overflow-hidden relative neon-border-purple p-2 flex items-center justify-center" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
